...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | You may exclude specific guidelines from being generated by adding
    | their keys to the exclude list.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | You may exclude specific skills from being activated by adding
    | their names to the exclude list.
    |
    */
