...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'api.pagination.default_size' => 'integer',
            'api.pagination.max_size' => 'integer',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'filesystems.links./home/norman/Projects/skeletons/laravel-starter-kit/public/storage' => 'string',
            ...
            'sentry.traces_sample_rate' => 'integer',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','concurrency.default','images.default',
...
'broadcasting.connections.null.driver','api.pagination.default_size','api.pagination.max_size','app.name','app.env',
...
'auth.passwords.users.throttle','auth.password_timeout','boost.enabled','boost.rules.enabled','boost.rules.scoped_guidelines',
...
'boost.executable_paths.vendor_bin','boost.browser_logs_watcher','boost.browser_log_levels','cache.default','cache.stores.array.driver',
...
'filesystems.links./home/norman/Projects/skeletons/laravel-starter-kit/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'services.slack.notifications.channel','services.context7.key','session.driver','session.lifetime','session.expire_on_close',
...
'session.http_only','session.same_site','session.partitioned','session.serialization','mcp.redirect_domains',
'mcp.custom_schemes','mcp.authorization_server','mcp.tool_search.max_tool_calls','mcp.tool_search.max_output_bytes','ide-helper.filename',
...
'boost.browser-logs','api.','storage.local',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','auth.not_hr_validated','auth.2fa',
'validation.ean',);
...
'VITE_SENTRY_DSN_PUBLIC','VITE_SENTRY_AUTH_TOKEN','VITE_SENTRY_TRACES_SAMPLE_RATE','VITE_SENTRY_PROJECT','VITE_SENTRY_ORG',);
